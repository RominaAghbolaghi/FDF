...
/*   Updated: 2023/05/11 11:35:32 by rmohamma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int length)
{
	...
	{
		fdf_file[width].x = (width - (data->width) / 2) * data->scale;
		fdf_file[width].y = (length - (data->length) / 2) * data->scale;
